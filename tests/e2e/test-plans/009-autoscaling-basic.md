...
```bash
unset AUTOBEAT_MIN_WORKERS AUTOBEAT_MAX_WORKERS
pkill -f "stress" || true
pkill -f "autobeat" || true
rm -rf .autobeat/
```
...
2. Clear environment: `unset AUTOBEAT_MIN_WORKERS AUTOBEAT_MAX_WORKERS`
3. Check CPU: `top -bn1`
